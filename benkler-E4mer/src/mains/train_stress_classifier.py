...
def finetune_stress_E4mer(pretrained_model='unlabelled_pretrain'):
    model.train_classifier(
        ...
        checkpoint_dir=os.path.join(ROOT_DIR, f"benkler-E4mer/checkpoint/stress_event_finetune/{pretrained_model}"),
        save_dir=os.path.join(ROOT_DIR, f"benkler-E4mer/models/stress_event_finetune/{pretrained_model}"),
