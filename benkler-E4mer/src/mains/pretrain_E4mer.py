...
def finetune_nurse_SSL(nurse):
    model.pretrain(
        ...
        checkpoint_dir=os.path.join(ROOT_DIR, f"benkler-E4mer/checkpoint/Nurse{nurse}_SSLFinetune"),
        save_dir=os.path.join(ROOT_DIR, f"benkler-E4mer/models/Nurse{nurse}_SSLFinetune"), 
